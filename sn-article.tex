...
%	D^{i+1}_{n+1}= \begin{cases}D_n & \text { if } \eta\leq-\frac{1}{3}	\\
%	D_n+\frac{\Delta\gamma}{\left(1-D^{i}_{n+1}\right)}\left[\frac{-Y_{n+1}}{r}\right]^s & \text { if } \eta>-\frac{1}{3}\end{cases}
	\dot{D} =
	\begin{cases}
