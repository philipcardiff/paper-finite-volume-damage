...
\begin{figure}[htbp]
	\centering
		...
		{
			\label{airbus}\includegraphics[width=0.3\textwidth]{./Figures/finiteVolumeImplementation/inhomogenousDeformation/forceDispAxi.png}
		}
		\subfigure[Flat notched bar]
		{
			\label{airbus}\includegraphics[width=0.3\textwidth]{./Figures/finiteVolumeImplementation/inhomogenousDeformation/forceDispBorden.png}
		}
...
%\end{center}
	\centering
		\subfigure[Notched round bar]
		{\includegraphics[width=0.3\textwidth]{./Figures/plasticityCompare/axiCompare/disp_EpsPEq.png}}
		\subfigure[Flat notched bar] 
...
\begin{figure}[htbp]
	\centering
		...
		{\includegraphics[width=0.3\textwidth]{./Figures/plasticityCompare/axiCompare/disp_sigmaEq.png}}
		\subfigure[Flat notched bar: Equivalent stress $\sigma_v$ vs displacement]
		{\label{airbus}\includegraphics[width=0.3\textwidth]{./Figures/plasticityCompare/bordenCompare/disp_sigmaEq.png}}
		
		\subfigure[Notched round bar: Pressure $p$ vs displacement] 
		{\includegraphics[width=0.3\textwidth]{./Figures/plasticityCompare/axiCompare/disp_Pressure.png}}
		...
		\subfigure[Notched round bar: Axial stress $\sigma_{yy}$ vs displacement] 
  		{\includegraphics[width=0.3\textwidth]{./Figures/plasticityCompare/axiCompare/disp_sigmaYY.png}}
...
\begin{figure}[htbp]
	\centering
		\subfigure[Non-local damage vs.displacement (mm)] {\label{airbus}\includegraphics[width=0.3\textwidth]{./Figures/LemaitreCompare/axiCompare/disp_damageNonLocal.png}}
		\subfigure[Equivalent plastic strain vs. displacement] {\label{boeing} \includegraphics[width=0.3\textwidth]{./Figures/LemaitreCompare/axiCompare/disp_EpsPEq.png}}
...
%it can lead to plastic strain localisations in the wire that may result in the procedure crashing, particularly when the damage models are employed.
%of  in the region of the wire in contact with the die. As the simulation moves forward a quasi steady-state solution is obtained. 
this approach can lead to convergence issues when incorporating damage, particularly in cases with large reduction ratios and high die angles. % which will be encountered in section 7.3.
