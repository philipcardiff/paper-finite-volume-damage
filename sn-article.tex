...
\end{equation}
\begin{equation}
\mathbf{B}_{trial}=\mathbf{f}^{[m+1]}\mathbf{B}^{[m]}(\mathbf{f}^{[m+1]})^{T}\nonumber
\end{equation}
\begin{equation}
\boldsymbol{\varepsilon}_{trial}=\frac{1}{2}ln[\textbf{B}_{trial}]\nonumber
\end{equation}
\begin{equation}
...
\begin{equation}
{q}_{trial}-g_p(d)3\mu\Delta\gamma-g_p(d)\sigma_{y}(\bar{\varepsilon}_{p}^{[m]}+\Delta\gamma)=0\nonumber
\end{equation}
(iv) Update elastic strain
%\begin{equation}
%\boldsymbol{\varepsilon}^{e}^{[m+1]}=\boldsymbol{\varepsilon}^{e}_{trial}-\sqrt{\frac{3}{2}}\Delta\gamma{\frac{dev(\boldsymbol{\varepsilon}^{e}_{trial})}{\lvert\lvert\boldsymbol{\varepsilon}^{e}_{trial}\rvert\rvert}}\nonumber
%\end{equation}
%\begin{equation}
%\boldsymbol{\tau}^{[m+1]}=g_e(d)\mathbf{D}^e:\boldsymbol{\varepsilon}^{e}^{[m+1]}\ 
